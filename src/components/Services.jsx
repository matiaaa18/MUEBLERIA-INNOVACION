...
const CATEGORIES = [
  {
    ...
    items: [
      'Muebles de Cocina',
      'Closets y Walk-in Closet',
      'Vanitorios',
      'Home Office',
      'Muebles para TV',
      'Muebles de Lavandería',
      'Centros de entretenimiento',
      'Muebles a medida en general',
    ],
  },
  {
    heading: 'Marmolería e Instalaciones',
    items: [
      'Cubiertas de Granito Natural',
      'Cubiertas de Cuarzo Engineered',
      'Cubiertas de Mármol',
      'Cubiertas de Porcelanato',
      'Cambio de cubierta existente',
      'Instalación de lavaplatos y grifería',
